...
function dropdownEffectData(t) {
      ...
      function e(t, e, i) {
        ...
        g || (g = i()), t.is(":visible") || (t.remove(), t = null, 0 === g.children().length && (g.remove(), b = void 0));
          ...
          C = { clear: r, remove: l, error: e, getContainer: i, info: n, options: {}, subscribe: o, success: a, version: "2.1.2", warning: s };return C;
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
}(__webpack_require__(49)), $(".smooth-scroll").on("click", "a", function (t) {
  ...
  function o(t, e, i) {
   ...
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), !(function webpackMissingModule() { var e = new Error("Cannot find module \"hammerjs\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())], __WEBPACK_AMD_DEFINE_FACTORY__ = (t),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
  ...
  }var a = __webpack_provided_window_dot_jQuery,
      s = a(window),
      r = a(document),
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(0), __webpack_require__(0), __webpack_require__(2)(module), __webpack_require__(3)))
